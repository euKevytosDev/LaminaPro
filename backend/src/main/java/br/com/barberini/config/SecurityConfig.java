...
import br.com.barberini.security.JwtAuthFilter;
        ...
        http
                ...
                .exceptionHandling(ex -> ex
                        .authenticationEntryPoint((req, res, e) ->
                                escreverJson(res, HttpServletResponse.SC_UNAUTHORIZED, "Faça login para continuar"))
                        .accessDeniedHandler((req, res, e) ->
                                escreverJson(res, HttpServletResponse.SC_FORBIDDEN, "Acesso negado"))
                )
